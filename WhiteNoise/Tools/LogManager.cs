...
namespace WhiteNoise.Tools
{
    ...
    public class LogManager
    {
        ...
        public LogManager(LogType logType)
            : this(Path.Combine(AppRoot.Root, "Log"), logType, null, null)
        {
        }

        public LogManager(string prefix, string postfix)
            : this(Path.Combine(AppRoot.Root, "Log"), LogType.Daily, prefix, postfix)
        {
        }

        public LogManager()
            : this(Path.Combine(AppRoot.Root, "Log"), LogType.Daily, null, null)
        {
        }
        #endregion
